...
<body>
    <div>
        <nav class="navbar navbar-light navbar-expand-md navigation-clean">
             <div class="container"><a class="navbar-brand" href="http://localhost:81/progect/add/add.php" style="font-size:25px;">evidence of the pilgrim</a><button class="navbar-toggler" data-toggle="collapse" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                <div
                    class="collapse navbar-collapse" id="navcol-1">
                    <ul class="nav navbar-nav ml-auto">
                        <li class="dropdown" style="width:133px;"><a class="dropdown-toggle nav-link dropdown-toggle" data-toggle="dropdown" aria-expanded="false" href="http://localhost:81/progect/home/">اللغة</a>
    ...
    <div style="width: 100%;height: 100%;"><form action="http://localhost:81/progect/phpfile/lkm.php" method="POST"enctype="text/plain">
        ...
        <div class="row clearfix">
            <div class="col-md-12 column">
                <table class="table table-bordered table-hover dynamic-table-tab_logic">
                    ...
                    <tbody>
                        <tr action="http://localhost:81/progect/phpfile/lkm.php" method="POST" enctype="text/plain">
                            <td><input type="text" name="Frist_name" placeholder="First Name" class="form-control" /></td>
                            <td><input type="text" name="last_name" placeholder="Last Name" class="form-control" /></td>
                            <td><input type="number" name="password" placeholder="Passport number" class="datetimepicker form-control" /></td>
                            <td><select type="text" name="conutry" placeholder="Please Select" class="form-control">
        <option value="m">
	...
	<option value="ZW">Zimbabwe</option>
        ...
        </div><button  class="dynamic-table-add_row btn btn-default pull-left" type="submit" value="Submit">Add Row</button></div>
</form><div>
<form method="post" action="http://localhost:81/progect/phpfile/d.php">
    <div class="table-responsive">
        <table class="table">
            <thead>
                <tr>
                    <th></th>
                    <th><br />First Name<br /></th>
                    <th><br />Last Name<br /></th>
                    <th><br />Passport number<br /></th>
                    <th><br />State Passport<br /></th>
                </tr>
            </thead>
            <tbody>
                <tr>
    ...
    <div role="group" class="btn-group"><button class="btn btn-primary" type="submit" name ="delete"id="delete" >Delete Row</button></div>
</form>
</div></div>
